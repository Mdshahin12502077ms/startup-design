...
@section('content')
    <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
        <div class="row py-5">
            <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                <h1 class="display-4 text-white animated zoomIn">Application Maintenance </h1>
                <a href="" class="h5 text-white">Home</a>
                <i class="far fa-circle text-white px-2"></i>
                <a href="" class="h5 text-white">Application Maintenance</a>
            </div>
        </div>
    </div>
    {{-- start  build perpose --}}
    ...
    {{-- why perfect start --}}
    <section class="per_web">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-1"></div>
                <div class="col-md-10 ">
                    <div class="mt-3 ">
                        <h2 class="text-center "  style="margin-top:10vh">How We Create Perfectly Tailored Websites</h2>
                    </div>
                    ...
                    <div class="row mt-5 mb-5">
                        ...
                        <div class="col-md-3 ">
                            <div class="card b_shadow wow fadeInUp" data-wow-delay="0.1s" style="margin-bottom: 10vh">
    ...
    <section>
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-1"></div>
                <div class="col-md-5 identify_content mb-3" style="margin-top: 20vh">
                    <div>
                         <p>
    ...
    <section class="container-fluid" style="margin-top: 20vh;margin-bottom:10vh">
        <div class="row">
            <div class="col-md-4 ">
                <div class="web_img">
                    <div class="mt-2">
    ...
    {{-- other web link end --}}
    {{-- Faqs start --}}
    <section class=" per_web container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="mx-auto text-center" style="margin-top: 10vh;">
            ...
            <div class="row">
                ...
                <div class="col-md-8"style="margin-bottom: 10vh">
                    <div class=" text-center pb-4" >
                        <div style="height:100%;background-color:white;line-height:50px;font-size:25px">
...
<section class="container" style="margin-top: 10vh">
    <div class="row">
        ...
        <div class="col-md-6 content_soft" style="margin-top: 20vh;margin-bottom:10vh">
       <p>
      ...
      <p>It’s not always that ads work on google searches as most people are too skeptical about them. We conduct thorough keyword research to optimize your webpages to organically rank on Google. This eliminates the chances of you losing skeptical customers while attracting those who find exactly what they’re looking for. Optimize your webpages when you design your business website with us and we will unleash the power of your website and make it rank on search engines organically.</p>
        ...
        {{--seo end--}}
        {{-- showcase start --}}
 <section class="showcase container-fluid" style="margin-bottom: 10vh;margin-top:10vh">
<div class="row">
    <div class="col-md-2"></div>
    ...
    <div class="col-md-2"></div>
          ...
          {{-- case studies start --}}
  <section class="container mt-5" style="margin-bottom: 10vh">
    <div class="row">

        <h2 class="text-center" style="margin-bottom: 10vh">Case Studies</h2>
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                <div>
